          ...
          <div className="klybrix-footer-brand">
            ...
            <div className="klybrix-social-section">
              ...
              <div className="klybrix-social-links">
                <a href="https://www.instagram.com/klybrix/" className="klybrix-social-link" aria-label="Instagram">
                ...
                <a href="https://www.youtube.com/@klybrixOfficial" className="klybrix-social-link" aria-label="YouTube">
                  <div className="klybrix-social-icon">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                ...
                <a href="https://www.tiktok.com/@klybrix" className="klybrix-social-link" aria-label="TikTok">
                  <div className="klybrix-social-icon">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
